                      ...
                      Column(
                        children: [
                          ...
                          Container(
                            ...
                            //color: Colors.black,
                            height: 40,//(MediaQuery.of(context).size.height)-800,
...
//padding: EdgeInsets.symmetric(horizontal: 8,vertical: 20),
                ...
                child: Align(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        LocalizationCubit.get(context).localization ? 'الليالي' : 'Nights',
                      ...
                      Text(
                        LocalizationCubit.get(context).localization ? 'عدد الايام ' : 'Days',
                ...
                children: [
                  Align(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          LocalizationCubit.get(context).localization ? 'السعر ' : 'price',
                  ...
                  Align(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          LocalizationCubit.get(context).localization ? 'الاعجابات' : 'Likes',
                  ...
                  Align(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          LocalizationCubit.get(context).localization ? 'الاماكن المتاحة' : 'places',
              ...
              Column(
                children: [
                  Align(
                    alignment: LocalizationCubit.get(context).localization ? Alignment.topRight : Alignment.topLeft,
                    child: Text(
                      LocalizationCubit.get(context).localization ? 'برنامج الرحلة ' : 'program',
              ...
              Column(
                children: [
                  Align(
                    alignment: LocalizationCubit.get(context).localization ? Alignment.topRight : Alignment.topLeft,
                    child: Text(
                      LocalizationCubit.get(context).localization ? ' رحلتنا تضمن' : 'our program include',
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: Center(
                    child: Text(
                      LocalizationCubit.get(context).localization ? 'احجز الان' : 'Book now',
                ...
                Container(
                  ...
                  child: MaterialButton(
                    child: Text(
                      LocalizationCubit.get(context).localization ? 'كاش' : 'by bank',
                ...
                Container(
                  ...
                  child: MaterialButton(
                    child: Text(
                      LocalizationCubit.get(context).localization ? 'عند الوصول' : 'when we arrive',
  ...
  Widget ratingg(){
    ...
    return Center(child: Row(children: [
      ...
      SizedBox(width: 10,),
      Text(
        LocalizationCubit.get(context).localization ? 'التقييم' : 'Rating',//S.of(context).pageRating,
        ...
        Container(
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
              ...
              hintText: LocalizationCubit.get(context).localization ? 'اكتب التعليق' : 'Enter Comment',//S.of(context).pageEnterComment,
